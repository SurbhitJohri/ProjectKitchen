import sys
global path1, path2
path1 = "C:\\Users\\ERY3041\\Downloads\\Code_new_21062023 (1)\\Code_new\\Working_codes"
path2 = "C:\\Users\\ERY3041\\Downloads\\Code_new_21062023 (1)\\Code_new"
...
attlist = pd.read_excel("C:\\Users\\ERY3041\\Downloads\\Code_new_21062023 (1)\\Code_new\\Attribute_list_to_drop_or_to_use.xlsx")
xl = pd.ExcelFile("C:\\Users\\ERY3041\\Downloads\\Code_new_21062023 (1)\\Code_new\\Attribute_list_to_drop_or_to_use.xlsx")
...
def populate_number_dropdown(model_type):    
    if model_type is None:
        ...
        df_modeltype = pd.read_csv(path2+'\\'+worksheet_name+'_final_global_results.csv')
...
def populate_cluster_dropdown(value):
    ...
    if value is None:
        ...
        df_cluster = pd.read_csv(path2+'\\'+worksheet_name+'_final_global_results.csv')
...
def populate_spec_dropdown(value1,value2):    
    ...
    if value1 is None or value2 is None:
       ...
       raise PreventUpdate
        ...
        newdf = pd.read_csv(path2+'\\'+worksheet_name+'_final_global_results.csv')
...
def showdata(tab,modeltype,modelno, clusterno,specno):
    ...
    if tab is None or modeltype is None or modelno is None or clusterno is None and specno is None:
        ...
        df_model = pd.read_csv(path2+'\\'+worksheet_name+'_final_global_results.csv')
